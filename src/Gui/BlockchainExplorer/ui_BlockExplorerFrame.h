...
public:
    ...
    void setupUi(QFrame *BlockExplorerFrame)
    {
        ...
        m_blockExplorerTabBar->setCurrentIndex(1);
    ...
    void retranslateUi(QFrame *BlockExplorerFrame)
    {
        ...
        m_blockExplorerTabBar->setTabText(m_blockExplorerTabBar->indexOf(m_transactionPoolTab), QApplication::translate("BlockExplorerFrame", "Ledger", 0));
    } // retranslateUi
