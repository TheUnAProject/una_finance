...
"}"));
        ...
        horizontalSpacer = new QSpacerItem(298, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
        ...
        m_mixinSlider->setMinimumSize(QSize(260, 0));
        m_mixinSlider->setMaximumSize(QSize(260, 16777215));
    ...
    void retranslateUi(QFrame *SendFrame)
    {
        ...
        label_3->setText(QApplication::translate("SendFrame", "PRIORITY (FEE)", 0));
